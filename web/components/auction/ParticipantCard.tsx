...
export function ParticipantCard({ name, tier, gameRank, prefCharacters, bio }: ParticipantCardProps) {
  return (
    <div className="w-full rounded-xl border-2 border-primary/20 bg-card overflow-hidden shadow-lg">
