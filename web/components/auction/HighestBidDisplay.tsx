...
export function HighestBidDisplay({ highestBid, minBidIncrement }: HighestBidDisplayProps) {
  return (
    <div className="relative overflow-hidden w-full rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 via-background to-card/40 p-6 shadow-xl flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-300">
      {/* Background patterns */}
        ...
        {highestBid ? (
          <div className="mt-3 flex flex-col items-center">
            ...
            <div className="mt-3 flex items-center gap-2 text-foreground">
              <span className="text-sm font-semibold text-muted-foreground">입찰자:</span>
              <span className="text-lg font-black text-foreground bg-muted/80 px-4 py-1 rounded-full border border-border shadow-sm max-w-[200px] truncate">
          ...
          <div className="mt-4 py-3 flex flex-col items-center">
            <span className="text-4xl md:text-5xl font-black font-mono text-muted-foreground">
            ...
            <div className="mt-4 text-xs text-muted-foreground font-bold border border-border px-3 py-1 rounded-full bg-background/40">
