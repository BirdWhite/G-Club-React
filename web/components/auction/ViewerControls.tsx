...
export function ViewerControls() {
  return (
    <div className="relative overflow-hidden w-full rounded-2xl border border-border bg-gradient-to-r from-background via-card to-background p-5 shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-4">
      {/* Glow animation */}
      ...
      <div className="flex items-center gap-3.5 z-10">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h4 className="font-extrabold text-sm text-foreground">실시간 경매 중계 시청 중</h4>
      ...
      <div className="flex items-center gap-2 bg-muted border border-border px-4 py-2 rounded-xl text-muted-foreground font-bold text-xs shrink-0 select-none z-10">
