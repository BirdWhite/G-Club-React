...
// 아이콘 (Lucide React)
import { Search, ShieldAlert, CheckCircle2, Loader2, UserPlus } from 'lucide-react';
...
export default function ValorantRegisterPage() {
  ...
  return (
    <div className="container max-w-2xl mx-auto py-12 px-4">
      ...
      <div className="bg-card border border-border shadow-lg overflow-hidden p-6 mb-8 rounded-xl">
        <form onSubmit={handleSearch} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-1">
              ...
              <div className="flex bg-background border border-input rounded-md focus-within:ring-2 focus-within:ring-primary">
                ...
                <input 
                  ...
                  placeholder="KR1"
                  className="w-full px-3 py-2 bg-transparent text-foreground focus:outline-none rounded-r-md"
                  disabled={isSearching || isRegistering}
                />
              </div>
            </div>
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 py-3 bg-primary text-primary-foreground font-medium rounded-md hover:bg-primary/90 transition-colors disabled:opacity-50"
          >
      ...
      {accountData && (
        <div className="bg-card border border-primary shadow-xl overflow-hidden rounded-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="p-6">
            ...
            <div className="mt-8">
              <button 
                ...
                className="w-full flex items-center justify-center gap-2 py-4 bg-primary text-primary-foreground font-bold text-lg rounded-xl shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:transform-none"
              >
                {isRegistering ? (
                  <>
